...
The specialized trainers in `theseus.training` support DPO and two-stage
KL regularization. KL uses the normal static `DATASET` declaration; its token
budgets control objective transitions.

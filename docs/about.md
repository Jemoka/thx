...
Sharing or adapting it must credit Houjun Liu and the theseus project with a link to [theseus.jemoka.com](https://theseus.jemoka.com). Any text use must be noncommercial, and adaptations must use the same license. See the [full documentation license terms](https://creativecommons.org/licenses/by-nc-sa/4.0/legalcode.en).

Copyright (c) 2026 Houjun Liu; all rights reserved unless otherwise stated in legal notices or where prohibited by applicable law.

<p align="center">
  <img src="assets/colophon.png" alt="" width="32">
</p>
